...
class KthLargest:
    ...
    def __init__(self, k: int, nums: list[int]):
        ...
        Args:
            k: The value of k (kth largest element).
        ...
        while len(self.heap) > k:
            heapq.heappop(self.heap) # Remove smallest elements until only k elements remain
    ...
    def add(self, val: int) -> int:
        ...
        Returns:
            The kth largest element in the stream after adding val.
        """
