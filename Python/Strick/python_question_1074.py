...
def longest_palindrome(s):
    ...
    # Initialize the diagonal elements to True, as single characters are palindromes
    for i in range(n):
        dp[i][i] = True

    # Initialize max_len and start to track the longest palindrome found so far
    max_len = 1
    start = 0
