    ...
    for cl in range(2, n + 1):
        for i in range(n - cl + 1):
            ...
            if s[i] == s[j]:
                ...
                # If the characters are different, then the LPS length is the maximum of
                # LPS length of the substring without the first character and
                # LPS length of the substring without the last character.
