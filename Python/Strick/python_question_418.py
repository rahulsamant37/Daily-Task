...
def longest_palindrome(s):
    """
    Finds the longest palindromic substring within the input string s.

    The approach uses dynamic programming. A table dp[i][j] is constructed, where dp[i][j] is True if the substring
    s[i:j+1] is a palindrome, and False otherwise.

    The table is filled in a bottom-up manner. The base cases are:
    ...
    For substrings of length 3 or more, dp[i][j] = True if s[i] == s[j] and dp[i+1][j-1] is True.
