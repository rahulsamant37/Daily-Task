...
Input: s = "babad"
Output: "bab" or "aba"
Explanation: "bab" is a palindrome, "aba" is a palindrome. Both are valid longest palindromic substrings.
...
def longest_palindrome(s):
    ...
    n = len(s)
    if n < 2:
        return s  # Single character string is a palindrome itself
