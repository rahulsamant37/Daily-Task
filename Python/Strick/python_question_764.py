...
Output: 6
Explanation: [1, 2, 3, 4, 5, 6] is a possible longest increasing subsequence.
'''

# Solution
def longest_increasing_subsequence_with_k_diff(nums, k):
    """
    Finds the length of the longest strictly increasing subsequence with a difference of at most k.
...
def test_solution():
    ...
    assert longest_increasing_subsequence_with_k_diff([1, 10, 2, 9, 3, 8, 4, 7, 5, 6], 3) == 6
    ...
    assert longest_increasing_subsequence_with_k_diff([1, 2, 4, 8, 16], 1) == 2
    assert longest_increasing_subsequence_with_k_diff([1, 2, 4, 8, 16], 3) == 3
    assert longest_increasing_subsequence_with_k_diff([1, 2, 4, 8, 16], 7) == 4
    assert longest_increasing_subsequence_with_k_diff([1, 2, 4, 8, 16], 15) == 5
    assert longest_increasing_subsequence_with_k_diff([], 5) == 0
    assert longest_increasing_subsequence_with_k_diff([5], 5) == 1
