...
Output: 4
Explanation: The longest increasing subsequence is [1, 2, 3, 4] or [2,3,4,5] with a length of 4.

Input: nums = [1, 5, 2, 4, 3], k = 2
Output: 3
Explanation: The longest increasing subsequence is [1, 2, 3], [1, 2, 4], [1, 3, 4], [2, 3, 4] or [2,4,5] with a length of 3.

Input: nums = [1, 10, 2, 9, 3, 8, 4, 7, 5, 6], k = 3
Output: 6
Explanation: The longest increasing subsequence is [1, 2, 3, 4, 5, 6] with a length of 6.
'''
