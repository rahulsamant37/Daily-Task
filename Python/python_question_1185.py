...
- You may assume `beginWord` and `endWord` are not empty and are not the same.
...
def solution():
    def word_ladder(beginWord, endWord, wordList):
        ...
        queue = deque([(beginWord, 1)]) # Queue of (word, level)
...
def test_solution():
    ...
    beginWord5 = "sand"
    endWord5 = "acne"
    wordList5 = ["slit","bale","pere","rake","cake","coke","cake"]
    expected5 = 0
