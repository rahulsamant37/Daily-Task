...
class KthLargest:
    ...
    def __init__(self, k: int, nums: list[int]):
        ...
        We use a min-heap to store the k largest numbers seen so far.
        """
        self.k = k
        self.heap = nums  # Initialize heap with provided numbers
        heapq.heapify(self.heap) # Convert the list into a heap
    ...
    def add(self, val: int) -> int:
        ...
        Otherwise, the heap remains unchanged.
        """
