...
def longest_palindrome(s):
    ...
    # Initialize longest palindrome to the first character
    start = 0
    max_len = 1
...
def test_longest_palindrome():
    ...
    assert longest_palindrome("") == ""
