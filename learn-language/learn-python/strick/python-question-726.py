...
def test_solution():
    ...
    beginWord4 = "sand"
    endWord4 = "acne"
    wordList4 = ["sand","acnd","acns","sand","acln","acls","acne","lcnn","sand","acnd","acns","acln","acls","lcnn"]
    expected4 = 0
    ...
    beginWord5 = "qa"
    endWord5 = "sq"
    wordList5 = ["si","go","se","cm","so","ph","mt","db","mb","sb","kr","ln","tm","ca","ir","mc","to","he","fi","sq","rb","pc","to","ea","rf","rh","er","co","ha","la","yt","wm","sb","tn","ca","ir","rb","sq"]
    expected5 = 5
    assert word_ladder(beginWord5, endWord5, wordList5) == 5, f"Test Case 5 Failed: Expected {5}, got {word_ladder(beginWord5, endWord5, wordList5)}"
