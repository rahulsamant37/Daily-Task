...
def test_solution():
    ...
    beginWord4 = "leet"
    endWord4 = "code"
    wordList4 = ["lest","leet","lose","code","lode","robe","lost"]
    expected4 = 6
    assert word_ladder(beginWord4, endWord4, wordList4) == 6, f"Test Case 4 Failed: Expected {6}, Got {word_ladder(beginWord4, endWord4, wordList4)}"
