...
def group_anagrams(strs):
    ...
    for s in strs:
        ...
        if sorted_s in anagram_groups:
            anagram_groups[sorted_s].append(s)  # If sorted string is already a key, append to the list
        else:
            anagram_groups[sorted_s] = [s]  # If sorted string is not a key, create a new list with the string
