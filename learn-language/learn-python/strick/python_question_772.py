...
Output: 3
Explanation: The longest increasing subsequence with a difference of at most 2 is [1, 2, 3], [1, 2, 4], [1, 3, 4], [2, 3, 4], [2, 4].
'''
...
def test_solution():
    ...
    assert longest_increasing_subsequence_with_k_difference([1, 2, 3, 5, 7, 9], 2) == 4
