...
*   You may assume that all words in `wordList` have the same length.
...
def test_solution():
    ...
    # Test case 5 (beginWord in wordList)
    beginWord5 = "hot"
    endWord5 = "dog"
    wordList5 = ["hot","dog"]
    expected5 = 0 # Not possible to reach dog from hot with only one step and existing in wordList.
    wordList5 = ["hot", "dog", "dot"]
    expected5 = 3
