...
def longest_palindrome(s):
    ...
    # Build up the dp table for longer palindromes
...
def test_longest_palindrome():
    ...
    assert longest_palindrome("bananas") in ("anana", "nanan") # Added test case to demonstrate the non-uniqueness of the longest palindromic substring
