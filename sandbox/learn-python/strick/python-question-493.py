...
class LRUCache:
    ...
    def __init__(self, capacity: int):
        ...
        Uses a dictionary for O(1) get and put operations and a doubly linked list to track the order of usage.
        """
    ...
    def put(self, key: int, value: int) -> None:
        ...
        When the cache reaches its capacity, it invalidates the least recently used item before inserting a new item.
        """
        if key in self.cache:
            node = self.cache[key]
            node.value = value
    ...
    def _pop_tail(self):
        """
        Helper function to remove and return the least recently used node (tail.prev) from the linked list.
        """
