...
Output: 5
Explanation: As one shortest transformation sequence is "hit" -> "hot" -> "dot" -> "dog" -> "cog",
return its length 5.
...
def test_solution():
    ...
    beginWord5 = "leetcode"
    endWord5 = "codeleet"
    wordList5 = ["leetcode","leet","codeleet"]
    assert solution(beginWord5, endWord5, wordList5) == 2
