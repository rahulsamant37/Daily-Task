    ...
    for length in range(2, n + 1):
        for i in range(n - length + 1):
            ...
            if s[i] == s[j]:
                ...
                # Otherwise, take the maximum of the lengths of the palindromic subsequences
                # obtained by either excluding the first character or excluding the last character
...
def test_longest_palindrome_subsequence():
    ...
    assert longest_palindrome_subsequence("abcda") == 3
