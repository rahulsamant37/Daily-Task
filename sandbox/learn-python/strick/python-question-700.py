...
def longest_palindromic_subsequence(s):
    ...
    for cl in range(2, n + 1):  # cl: current length of the subsequence
        for i in range(n - cl + 1):
            j = i + cl - 1  # j: end index of the subsequence
            ...
            # of the longest palindromic subsequence of the substring without these two characters.
            if s[i] == s[j]:
                dp[i][j] = dp[i + 1][j - 1] + 2
            ...
            # obtained by removing either the start or the end character.
            else:
