...
def test_solution():
    ...
    assert word_ladder("hot", "dog", ["hot","dog"]) == 0 # "hot" -> "dot" -> "dog" is not valid without "dot"
    assert word_ladder("hot", "dog", ["hot","dog", "dot"]) == 0 # Still 0, since no change is allowed
    assert word_ladder("hot", "dog", ["hot","dot","dog"]) == 3
