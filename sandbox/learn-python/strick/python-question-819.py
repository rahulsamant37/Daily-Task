...
class LRUCache:
    ...
    def __init__(self, capacity: int):
        ...
        # Initialize a dictionary to store the key-node pairs
        self.cache = {}
        # Initialize a doubly linked list to track the order of usage
    ...
    def put(self, key: int, value: int) -> None:
        ...
        if key in self.cache:
            ...
            # Create a new node
            node = Node(key, value)
            # Add the node to the cache and the head of the linked list
            self.cache[key] = node
            self._add(node)
