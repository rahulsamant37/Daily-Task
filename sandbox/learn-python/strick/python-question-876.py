...
def solution():
    def ladderLength(beginWord: str, endWord: str, wordList: list[str]) -> int:
        ...
        queue = deque([(beginWord, 1)])  # Store word and its distance from beginWord
        visited = {beginWord}
...
def test_solution():
    ...
    expected4 = 1
    assert ladderLength(beginWord4, endWord4, wordList4) == 1, f"Test Case 4 Failed: Expected {1}, Got {ladderLength(beginWord4, endWord4, wordList4)}"
